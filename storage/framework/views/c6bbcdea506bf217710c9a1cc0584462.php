...
<head>
    ...
    <?php if(in_array($analysis->status, ['pending', 'processing'], true)): ?>
        <meta http-equiv="refresh" content="5">
    <?php endif; ?>
    <title>Estado de generación · Minutes Generator</title>
    <style>
        :root { --bg: #f1f5f9; --card: #ffffff; --text: #0f172a; --muted: #64748b; --border: #e2e8f0; --primary: <?php echo e($brandColor); ?>; --danger: #991b1b; --success: #166534; }
...
<body>
    <main class="page">
        <div class="topbar">
            ...
            <a class="button secondary" href="<?php echo e(route('minutes-generator.index')); ?>">Volver al panel</a>
        </div>
        ...
        <section class="card">
            ...
            <span class="status <?php echo e($analysis->status); ?>"><?php echo e($analysis->status); ?></span>
            ...
            <?php elseif($analysis->status === 'completed' && $minute): ?>
                <p>La IA terminó el análisis y guardó la minuta generada.</p>
                <div class="actions">
                    <a class="button" href="<?php echo e(route('minutes-generator.show', $minute)); ?>">Ver minuta</a>
                    <a class="button secondary" href="<?php echo e(route('minutes-generator.index')); ?>">Generar otra minuta</a>
                </div>
            <?php elseif($analysis->status === 'failed'): ?>
                <p>No se pudo generar la minuta.</p>
                <p class="error"><?php echo e($analysis->error_message ?: 'Revisá la configuración de IA o intentá nuevamente.'); ?></p>
                <div class="actions">
                    <a class="button" href="<?php echo e(route('minutes-generator.index')); ?>">Intentar nuevamente</a>
                </div>
            <?php else: ?>
...
<?php /**PATH /home/runner/work/minutes-generator/minutes-generator/resources/views/minutes-generator/status.blade.php ENDPATH**/ ?>